...
{f.title("AthenaGuiLib", to_str)} v{_version()}
is made by Andreas Sas and is a library which handles a lot of the DearPyGui setup needed for other applications
{line}
""", to_str)
